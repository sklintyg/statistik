			...
			<div class="span3 bs-docs-sidebar" ng-controller="NavigationMenuCtrl">
				...
				<div class="statistics accordion" id="statistics-menu-accordion">
					...
					<!-- BUSINESS STATISTIC MENU -->
					  <div class="accordion-heading statistics-menu">
					    <a class="accordion-toggle first-level-menu" id="business-statistics-toggle" data-parent="#statistics-menu-accordion" href="#business-statistics-collapse" ng-class="{active: showOperation, collapsed: !showOperation, disabled: !is_loggedin}" ng-click="toggleOperationAccordion()">
