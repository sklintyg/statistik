...
public class DiagnosisSubGroupsConverterTest {
    ...
    public void converterTopColumnsTest() {
        ...
        assertEquals("[period1]", data.getFemaleChart().getCategories().toString());
        assertEquals("[A00-B94 name1: [55], A00-B95 name1: [8], A00-B93 name1: [7], A00-B97 name1: [6], A00-B91 name1: [4], A00-B90 name1: [3], Övriga diagnoskapitel: [3]]", data.getFemaleChart().getSeries().toString());

        assertEquals("[period1]", data.getMaleChart().getCategories().toString());
        assertEquals("[A00-B94 name1: [50], A00-B95 name1: [80], A00-B93 name1: [70], A00-B97 name1: [60], A00-B91 name1: [40], A00-B90 name1: [30], Övriga diagnoskapitel: [30]]", data.getMaleChart().getSeries().toString());

        assertEquals("[[;1, A00-B90 name1;2, A00-B91 name1;2, A00-B92 name1;2, A00-B93 name1;2, A00-B94 name1;2, A00-B95 name1;2, A00-B96 name1;2, A00-B97 name1;2, ;1], [Period;1, Kvinnor;1, Män;1, Kvinnor;1, Män;1, Kvinnor;1, Män;1, Kvinnor;1, Män;1, Kvinnor;1, Män;1, Kvinnor;1, Män;1, Kvinnor;1, Män;1, Kvinnor;1, Män;1, Summering;1]]", data.getTableData().getHeaders().toString());
