...
class TaskCoordinatorServiceImplTest {
  ...
  void setUp() {
    ...
    taskCoordinatorService =
        new TaskCoordinatorServiceImpl(
            simultaneousCallsAllowed, taskCoordinatorCache, objectMapper);
  }
  ...
  class Request {
    ...
    class UserHasCurrentlyOngoingRequestsStoredInRedis {
      ...
      @Test
      void shouldReturnTaskCoordinatorAcceptedIfOnlyOneRequestIsFound()
    ...
    class MultipleUsersHasyOngoingRequestsStoredInRedis {
      ...
      @Test
      void shouldReturnTaskCoordinatorAcceptedIfOneRequestIsFoundForUser()
          throws JsonProcessingException {
      ...
      @Test
      void shouldReturnTaskCoordinatorDeniedIfTwoRequestIsFoundForUser()
          throws JsonProcessingException {
    ...
    class RedisCacheGetsUpdatedCorrectly {
      ...
      void shouldNotAddNewRequestIfDeclined() throws JsonProcessingException {
        ...
        final var requestsStoredInRedis =
            Integer.parseInt(taskCoordinatorCache.get(USER_HSA_ID, String.class));
    ...
    class UnlimitedRequests {
      ...
      void setUp() {
        ...
        objectMapper = new ObjectMapper();
        taskCoordinatorService =
            new TaskCoordinatorServiceImpl(-1, taskCoordinatorCache, objectMapper);
      }
  ...
  class ClearRequests {
    ...
    void shouldClearRequestFromCacheIfMultipleRequestsAreStored() throws JsonProcessingException {
      ...
      final var actualResultUser =
          Integer.parseInt(taskCoordinatorCache.get(USER_HSA_ID, String.class));
      final var actualResultAnotherUser =
          Integer.parseInt(taskCoordinatorCache.get(ANOTHER_USER_HSA_ID, String.class));

      assertAll(
          () -> assertEquals(0, actualResultUser), () -> assertEquals(1, actualResultAnotherUser));
    }
