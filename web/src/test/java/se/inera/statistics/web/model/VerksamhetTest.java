...
public class VerksamhetTest {
  ...
  public void encodeId() {
    assertEquals(
        "Verksamhet1_u002FStora_u0020huset", Verksamhet.encodeId("Verksamhet1/Stora huset"));
  }
  ...
  public void encodeIdAllAllowed() {
    assertEquals(
        ...
        Verksamhet.encodeId("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-"));
  }
  ...
  public void decodeId() {
    assertEquals(
        "Verksamhet1/Stora huset", Verksamhet.decodeId("Verksamhet1_u002FStora_u0020huset"));
  }
  ...
  public void decodeIdAllAllowed() {
    assertEquals(
        "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-",
        Verksamhet.decodeId("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-"));
  }
