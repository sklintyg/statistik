...
public class LogInInterceptorTest {
  ...
  @InjectMocks LogInInterceptor testee = new LogInInterceptor();

  @Test
  public void testLoggingOfFileUploading() throws Exception {
    String payload =
        "------WebKitFormBoundary6UVVf08Ori6LNKyB\n"
    ...
    loggingMessage
        .getContentType()
        .append("multipart/form-data; boundary=----WebKitFormBoundary6UVVf08Ori6LNKyB");
    loggingMessage
        .getHeader()
        .append(
  ...
  public void testLoggingOfCreatePdf() throws Exception {
    String payload =
        "pdf=JVBERi0xLjMKJf%2F%2F%2F%2F8KMTAgMCBvYmoKPDwKL1R5cGUgL0V4dEdTdGF0ZQovY2"
