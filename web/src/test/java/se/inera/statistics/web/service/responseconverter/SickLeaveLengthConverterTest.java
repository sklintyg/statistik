...
public class SickLeaveLengthConverterTest {
  ...
  public void convertCasesPerMonthDataTest() {
    ...
    SimpleKonResponse sjukfallslangdResponse =
        new SimpleKonResponse(AvailableFilters.getForSjukfall(), sjukfallslangdRows);
    ...
    assertEquals(
        "[< 20 dagar, 20-50 dagar, > 50 dagar]", chartDataResult.getCategories().toString());
