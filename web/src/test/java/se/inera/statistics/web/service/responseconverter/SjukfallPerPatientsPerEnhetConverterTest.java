...
public class SjukfallPerPatientsPerEnhetConverterTest {
  ...
  public void testConvertNullRegionsEnhetsInputGivesEmptyOutput() {
    ...
    final SjukfallPerPatientsPerEnhetConverter sjukfallPerPatientsPerEnhetConverter =
        new SjukfallPerPatientsPerEnhetConverter(regionEnhets, Collections.<HsaIdEnhet>emptyList());
    ...
    final SimpleDetailsData result =
        sjukfallPerPatientsPerEnhetConverter.convert(
            casesPerMonth,
            new FilterSettings(
                Filter.empty(), Range.createForLastMonthsIncludingCurrent(12, clock)),
            createMessage());
  ...
  public void testConvertNonRegionsEnhetsInputGivesNonEmptyOutputWhereEnhetsNotInListAreRemoved() {
    ...
    final List<RegionEnhet> regionEnhets =
        Arrays.asList(new RegionEnhet(2L, new HsaIdEnhet("HSA2"), 2));
    final SjukfallPerPatientsPerEnhetConverter sjukfallPerPatientsPerEnhetConverter =
        new SjukfallPerPatientsPerEnhetConverter(regionEnhets, Collections.<HsaIdEnhet>emptyList());
  ...
  public void testConvertEnhetsWithZeroPatientsAreNotPartOfResult() {
    ...
    final List<RegionEnhet> regionEnhets =
        Arrays.asList(
            new RegionEnhet(1L, new HsaIdEnhet("HSA1"), 1),
            new RegionEnhet(2L, new HsaIdEnhet("HSA2"), 0));
    final SjukfallPerPatientsPerEnhetConverter sjukfallPerPatientsPerEnhetConverter =
        new SjukfallPerPatientsPerEnhetConverter(regionEnhets, Collections.<HsaIdEnhet>emptyList());
  ...
  public void testConvertEnhetsWithLessThanZeroPatientsAreNotPartOfResult() {
    ...
    final List<RegionEnhet> regionEnhets =
        Arrays.asList(
            new RegionEnhet(1L, new HsaIdEnhet("HSA1"), -1),
            new RegionEnhet(2L, new HsaIdEnhet("HSA2"), 3));
    final SjukfallPerPatientsPerEnhetConverter sjukfallPerPatientsPerEnhetConverter =
        new SjukfallPerPatientsPerEnhetConverter(regionEnhets, Collections.<HsaIdEnhet>emptyList());
  ...
  public void testConvertEnhetsWithUnsetNumberOfPatientsAreNotPartOfResult() {
    ...
    final List<RegionEnhet> regionEnhets =
        Arrays.asList(
            new RegionEnhet(1L, new HsaIdEnhet("HSA1"), null),
            new RegionEnhet(2L, new HsaIdEnhet("HSA2"), 3));
    final SjukfallPerPatientsPerEnhetConverter sjukfallPerPatientsPerEnhetConverter =
        new SjukfallPerPatientsPerEnhetConverter(regionEnhets, Collections.<HsaIdEnhet>emptyList());
  ...
  public void testConvertResultIsUsingTwoDecimalsForBothTableAndChart() {
    // Given
    final List<RegionEnhet> regionEnhets =
        Arrays.asList(new RegionEnhet(1L, new HsaIdEnhet("HSA1"), 3000));
    final SjukfallPerPatientsPerEnhetConverter sjukfallPerPatientsPerEnhetConverter =
        new SjukfallPerPatientsPerEnhetConverter(regionEnhets, Collections.<HsaIdEnhet>emptyList());
  ...
  public void testConvertEnhetsHasCorrectSortingSTATISTIK1034() {
    ...
    final List<RegionEnhet> regionEnhets =
        Arrays.asList(
            new RegionEnhet(1L, new HsaIdEnhet("HSA1"), 1000),
            new RegionEnhet(2L, new HsaIdEnhet("HSA2"), 1000),
  ...
  public void testRoundToTwoDecimalsAndFormatToString() {
    final String result =
        SjukfallPerPatientsPerEnhetConverter.roundToTwoDecimalsAndFormatToString(1.2345F);
  ...
  public void testRoundToTwoDecimalsAndFormatToStringAddDecimal() {
    final String result =
        SjukfallPerPatientsPerEnhetConverter.roundToTwoDecimalsAndFormatToString(1.2F);
  ...
  public void testRoundToTwoDecimalsAndFormatToStringRountUpCorrectly() {
    final String result =
        SjukfallPerPatientsPerEnhetConverter.roundToTwoDecimalsAndFormatToString(1.235F);
