...
public class AvsnittConverterTest {
  ...
  public void tableConverterTest() {
    ...
    DiagnosgruppResponse resp =
        new DiagnosgruppResponse(AvailableFilters.getForSjukfall(), avsnitts, rows);
    ...
    // Then
    assertEquals(
        "[[;1, ;1, A01-B99 name1;3], [Period;1, Antal sjukfall totalt;1, Totalt;1, Kvinnor;1, Män;1]]",
  ...
  public void converterTest() {
    ...
    assertTrue(
        data.getFemaleChart()
            .getSeries()
            .toString()
            .contains("A00-E90, G00-L99, N00-N99 Somatiska sjukdomar: [3]"),
        data.getFemaleChart().getSeries().toString());
    ...
    assertTrue(
        data.getMaleChart()
            .getSeries()
            .toString()
            .contains("A00-E90, G00-L99, N00-N99 Somatiska sjukdomar: [2]"),
        data.getMaleChart().getSeries().toString());

    assertEquals(
        "[[;1, ;1, A00-B99 name1;3], [Period;1, Antal sjukfall totalt;1, Totalt;1, Kvinnor;1, Män;1]]",
