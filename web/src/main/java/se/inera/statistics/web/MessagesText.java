...
public final class MessagesText {
    ...
    public static final String MESSAGE_NO_DATA_FILTER = "Det finns ingen statistik att visa för den angivna filtreringen. Överväg en mindre restriktiv filtrering.";
    ...
    public static final String STATISTICS_LEVEL_LANDSTING = "Landstingsstatistik";
