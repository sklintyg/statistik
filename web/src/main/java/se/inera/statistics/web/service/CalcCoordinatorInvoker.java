...
public class CalcCoordinatorInvoker extends JAXRSInvoker {
  ...
  public Object invoke(Exchange exchange, Object requestParams, Object resourceObject) {
    ...
    try {
      return calcCoordinator.submit(
          () -> super.invoke(exchange, requestParams, resourceObject), userHsaId, requestEndpoint);
    } catch (Fault f) {
      ...
      LOG.info(
          "Request completed for {}. Total time taken for request to finish: {} seconds. Request endpoint: {}",
          userHsaId,
