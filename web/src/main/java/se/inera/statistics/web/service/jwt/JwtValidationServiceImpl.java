 ...
 */
package se.inera.statistics.web.service.jwt;
...
public class JwtValidationServiceImpl implements JwtValidationService {
    ...
    public Jws<Claims> validateJwsToken(String jwtToken) {
        ...
        return Jwts.parserBuilder()
            .setSigningKeyResolver(new StatistikSigningKeyResolverAdapter(provider))
    ...
    private class StatistikSigningKeyResolverAdapter extends SigningKeyResolverAdapter {

        private JwkProvider provider;

        StatistikSigningKeyResolverAdapter(JwkProvider provider) {
