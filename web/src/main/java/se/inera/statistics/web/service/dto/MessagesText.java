...
public final class MessagesText {
  ...
  public static final String MESSAGE_NO_DATA =
      "Ingen data tillgänglig. Det beror på att det inte finns någon data för verksamheten.";
  public static final String MESSAGE_TOO_MUCH_DATA =
      "Rapporten innehåller mycket data, vilket kan göra diagrammet svårt att läsa. "
          + "Överväg att filtrera resultatet för att minska mängden data.";
  public static final String MESSAGE_DIAGNOS_MISS_MATCH =
      "Du har gjort ett val av diagnos som inte matchar det val du gjort i "
          + "diagnosfiltret (se 'Visa alla aktiva filter' ovan).";
  public static final String MESSAGE_NO_DIAGNOSIS = "Inga diagnoser valda";
  public static final String MESSAGE_OVERVIEW_WITH_FILTER =
      "Översikten visar alltid de senaste tre avslutade kalendermånaderna (%s) "
  ...
  public static final String FILTER_WRONG_FROM_AND_END_DATE =
      "Det finns ingen statistik innan %s och ingen efter %s, visar statistik "
          + "mellan %s och %s.";
  public static final String FILTER_WRONG_FROM_DATE =
      "Det finns ingen statistik innan %s. Visar statistik från tidigast möjliga datum.";
  public static final String FILTER_WRONG_END_DATE =
      "Det finns ingen statistik efter %s. Visar statistik fram till senast möjliga " + "datum.";
  public static final String FILTER_TOO_EARLY_FROM_AND_END_DATE =
      "Det finns ingen statistik innan 2013-10. Vänligen välj ett senare " + "från- och tilldatum.";
  public static final String FILTER_TOO_LATE_FROM_AND_END_DATE =
      "Du har valt två framtida datum. Vänligen välj ett tidigare " + "från- och tilldatum.";

  public static final String FILTER_NO_DATA =
      "Det finns ingen statistik att visa för den angivna filtreringen. Överväg en mindre "
          + "restriktiv filtrering.";
  public static final String FILTER_COULD_NOT_APPLY =
  ...
  public static final String REPORT_COLUMN_ANTAL_KOMPLETTERINGAR_TOTALT =
      "Antal kompletteringar totalt";
  public static final String REPORT_COLUMN_ANTAL_KOMPLETTERINGAR_MALE =
      "Antal kompletteringar för män";
  public static final String REPORT_COLUMN_ANTAL_KOMPLETTERINGAR_FEMALE =
      "Antal kompletteringar för kvinnor";
  ...
  public static final String REPORT_ANTAL_SJUKFALL_PER_1000_INVANARE =
      "Antal sjukfall per 1000 invånare";
  public static final String REPORT_ANTAL_LISTNINGAR = "Antal listningar i arbetsför ålder";
  public static final String REPORT_ANTAL_SJUKFALL_PER_1000_LISTNINGAR =
      "Antal sjukfall per 1000 listningar";
  ...
  public static final String REPORT_ANDEL_KOMPLETTERINGAR =
      "Total andel som fått komplettering, alla intygstyper inkluderade";
  ...
  public static final String REPORT_ANTAL_SJUKFALL_PER_1000 =
      "Antal sjukfall per 1000 listningar i arbetsför ålder";
