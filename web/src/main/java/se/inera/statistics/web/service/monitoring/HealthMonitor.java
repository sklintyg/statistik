...
public class HealthMonitor extends Collector {
  ...
  @Autowired private ChartDataService chartDataService;
  ...
  public void init() {
    ...
    this.chartserviceAccessible =
        register("chartservice_accessible", "0 == OK 1 == NOT OK", NORMAL);
    this.register();
  ...
  private Gauge register(String name, String help, String type) {
    return Gauge.build().name(PREFIX + name + type).help(help).register();
  }
