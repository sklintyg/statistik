 ...
 */
public class StatistikSAMLLogoutFilter extends SAMLLogoutFilter {


    public StatistikSAMLLogoutFilter(LogoutSuccessHandler logoutSuccessHandler, LogoutHandler[] localHandler,
