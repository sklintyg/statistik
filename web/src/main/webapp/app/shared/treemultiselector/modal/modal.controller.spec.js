...
describe('Controller: TreeMultiSelectorModalCtrl', function() {
  ...
  beforeEach(inject(function($controller, treeMultiSelectorUtil) {
    ...
    ctrl = $controller('TreeMultiSelectorModalCtrl',
        {$scope: scope, directiveScope: directiveScope, $element: {}, $uibModalInstance: {}, treeMultiSelectorUtil: treeMultiSelectorUtil});
  }));
  ...
  it('hide items not matching filter', inject(function() {
    ...
    var expectedResult = joc({
      visibleSubs: [
        joc({
          visibleName: 'enhet1', visibleSubs: [
