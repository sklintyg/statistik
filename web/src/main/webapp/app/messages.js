...
var stMessages = {
    'sv': {
        ...
        'help.region.sjukfall-totalt': 'Denna rapport visar sammanlagd statistik för de vårdenheter som tillhör regionet och som utfärdar läkarintyg. Information om vilka vårdenheter som ingår i regionet har rapporteras in av regionet självt %0.',
        'help.region.vardenhet': 'Denna rapport visar statistik för de vårdenheter som tillhör regionet och som utfärdar läkarintyg. Information om vilka vårdenheter som ingår i regionet har rapporterats in av regionet självt %0. Vårdenheternas namn hämtas från HSA-katalogen.',
        'help.region.vardenhet-listning1': 'Denna rapport visar statistik för de vårdenheter som tillhör regionet och för vilka antal listade patienter i arbetsför ålder rapporterats in. Antal sjukfall per 1000 listningar är ett mått som gör att det går att jämföra antalet sjukfall på olika vårdenheter trots att vårdenheterna inte är lika stora. Detta eftersom antalet sjukfall sätts i relation till antalet listade patienter i arbetsför ålder.',
        'help.region.vardenhet-listning2': 'Information om vilka vårdenheter som ingår i regionet och uppgift om antal listade patienter i arbetsför ålder på respektive vårdenhet har rapporteras in av regionet självt %0. Vårdenheternas namn hämtas från HSA-katalogen.',
        'help.region.meddelandenperamne': 'Denna rapport visar sammanlagd statistik för de vårdenheter som tillhör regionet och som utfärdar läkarintyg. Information om vilka vårdenheter som ingår i regionet har rapporteras in av regionet självt %0. Ämnet på meddelanden sätts av Försäkringskassan. Observera att statistiken i denna rapport endast innefattar de meddelanden som tillhör Försäkringskassans intyg (med undantag för FK 7263).',
        'help.region.meddelandenperamneochenhet': 'Denna rapport visar statistik för de vårdenheter som tillhör regionet och som utfärdar läkarintyg och läkarutlåtanden. Information om vilka vårdenheter som ingår i regionet har rapporterats in av regionet självt %0. Vårdenheternas namn hämtas från HSA-katalogen. Observera att statistiken i denna rapport endast innefattar de meddelanden som tillhör Försäkringskassans intyg (med undantag för FK 7263).',
        'help.region.intygpertyp': 'Denna rapport visar sammanlagd statistik för de vårdenheter som tillhör regionet och som utfärdar läkarintyg. Information om vilka vårdenheter som ingår i regionet har rapporteras in av regionet självt %0.',
        'help.region.komplettering': 'Denna rapport visar statistik över andelen intyg av de som skickas till Försäkringskassan som får ett meddelande med ämnet Komplettering. Rapporten visar sammanlagd statistik för de vårdenheter som tillhör regionet och som utfärdar läkarintyg. Information om vilka vårdenheter som ingår i regionet har rapporteras in av regionet självt %0.',
        ...
        'login.alert-info.behorighet': 'Medarbetaruppdrag saknas. Det krävs antingen minst ett giltigt medarbetaruppdrag med ändamål \'Statistik\' eller en systemroll till tjänsten för att använda Intygsstatistik.',
        'login.alert-inaktivitet': 'Du är utloggad. Du har blivit utloggad från Intygsstatistik på grund av inaktivitet. Om du vill fortsätta använda Intygsstatistik behöver du logga in igen.',
        'login.alert-loginfailed': 'Inloggningen misslyckades. Detta kan bero på att du saknar behörighet till Intygsstatistik.',
