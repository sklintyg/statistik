...
(function() {
    ...
    function NavigationMenuCtrl($rootScope, $scope, $location, AppModel, UserModel, StaticData, _, ControllerCommons, navigationViewState) {
        ...
        function initValues() {
            ...
            var sjukfallVerksamhet = {
                ...
                subMenu: [{
                    ...
                    subMenu: [{
                        ...
                        link: '#/verksamhet/jamforDiagnoser/' + navigationViewState.get().diagnosHash,
            ...
            nationell = [sjukfallNationell, intygNationell, kommunikationNationell, about];
            verksamhet = [sjukfallVerksamhet, intygVerksamhet, kommunikationVerksamhet, about];
            landsting = [sjukfallLandsting, intygLandsting, kommunikationLandsting, about];
        }
