...
.factory('pdfOverviewFactory',
    ...
    function(pdfFactory, $timeout) {
      ...
      function _printOverview($scope, charts) {
        ...
        _generateOverview(headers, charts, $scope.activeEnhetsFilters, $scope.activeEnhetsFiltersAllSelected, $scope.activeDiagnosFilters,
            $scope.activeSjukskrivningslangdsFilters, $scope.activeAldersgruppFilters, $scope.activeIntygstypFilters, pdfDoneCallback);
      }

      function _generateOverview(headers, charts, enhetsFilter, enhetsFilterAllSelected, diagnosFilter, sjukskrivningslangdFilter,
          aldersgruppFilter, intygstyperFilter, pdfDoneCallback) {
        var content = [];

        pdfFactory.factory.header(content, headers);

        pdfFactory.factory.allFilters(content, enhetsFilterAllSelected, enhetsFilter, diagnosFilter, sjukskrivningslangdFilter,
            aldersgruppFilter, intygstyperFilter);
