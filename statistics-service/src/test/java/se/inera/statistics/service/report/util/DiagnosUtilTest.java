...
public class DiagnosUtilTest {
    ...
    public void testGetSubGroupForCode() {
        Avsnitt subGroupForCode = util.getAvsnittForCode("T57");
        assertEquals("T51-T65", subGroupForCode.getId());
    }

    @Test
    public void testGetSubGroupForLongCode() {
        Avsnitt subGroupForCode = util.getAvsnittForCode("T5712");
        assertEquals("T51-T65", subGroupForCode.getId());
    }
    ...
    public void testGetAllDiagnosisGroups() {
        List<Avsnitt> allAvsnitts = DiagnosUtil.getAllDiagnosisGroups();
    ...
    public void testGetSubDiagnosisGroups() {
        List<Avsnitt> allAvsnitts = util.getSubGroups("C00-D48");
