...
public class QueueHelper {
    ...
    private void printAndGetSjukfallslangdGrupp(String vardenhet1, String vardenhet2, Range range, Map<String, TestData> result) {
        SickLeaveLengthResponse sjukfallslangdGrupp1 = sjukfallslangdGrupp.getHistoricalStatistics(vardenhet1, range.getFrom(), RollingLength.YEAR);
        ...
        SickLeaveLengthResponse sjukfallslangdGrupp2 = sjukfallslangdGrupp.getHistoricalStatistics(vardenhet2, range.getFrom(), RollingLength.YEAR);
        ...
        SickLeaveLengthResponse sjukfallslangdGruppNationell = sjukfallslangdGrupp.getHistoricalStatistics(nationell, range.getFrom(), RollingLength.YEAR);
