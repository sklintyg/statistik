...
class AnonymiseraTsDiabetes {
    ...
    AnonymiseraTsDiabetes(AnonymiseraPersonId anonymiseraPersonId, AnonymiseraHsaId anonymiseraHsaId,
                          AnonymiseraDatum anonymiseraDatum) {
    ...
    private void anonymizeCertificateXml(def intyg) {
        ...
        anonymizeNode intyg.intyg.diabetes.annanBehandlingBeskrivning
        anonymizeNode intyg.intyg.hypoglykemier.allvarligForekomstBeskrivning
        anonymizeNode intyg.intyg.hypoglykemier.allvarligForekomstTrafikBeskrivning
