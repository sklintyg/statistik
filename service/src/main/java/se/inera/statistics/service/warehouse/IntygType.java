...
public enum IntygType {
  ...
  AF00251(
      ...
      "af00251",
      "AF00251",
      "AF00251 Läkarintyg för deltagare i arbetsmarknadspolitiska program "
  ...
  TSTRK1031(
      ...
      true),
  TSTRK1009(
      "TSTRK1009", "tstrk1009", "TSTRK1009", "TSTRK1009 Transportstyrelsen Läkares anmälan", true),
  TSTRK1062(
      "TSTRK1062", "tstrk1062", "TSTRK1062", "TSTRK1062 Transportstyrelsens läkarintyg ADHD", true),
  ...
  FK7426(
      ...
      "fk7426",
      "FK 7426",
      "FK 7426 Läkarutlåtande tillfällig föräldrapenning för ett allvarligt sjukt barn som inte har fyllt 18",
      true),
  FK7427(
      "LU_TFP_B12_16",
      "fk7427",
      "FK 7427",
      "FK 7427 Läkarutlåtande tillfällig föräldrapenning barn 12–16 år",
      true),
  ...
  TS8071(
      ...
      "ts8071",
      "TS8071",
      "TS8071 Läkarintyg för högre körkortsbehörigheter, taxiförarlegitimation och på begäran av Transportstyrelsen",
      true),
  FK3221(
      "LU_OMV_MEK",
      "fk3221",
  ...
  FK7272("LUSHS", "fk7272", "FK 7272", "Läkarutlåtande för särskilt högriskskydd", true);
  ...
  private final String
      itIntygType; // The type name Intygtjansten is using and sends as metadata with all intyg
