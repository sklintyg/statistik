...
public class MeddelandehandelseMessagewidelineResultDao {

    private final Integer meddelandehandelseResult;

    private final Integer messagewidelineResult;

    public MeddelandehandelseMessagewidelineResultDao(Integer meddelandehandelseResult, Integer messagewidelineResult) {
