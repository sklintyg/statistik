...
public class NationellDataInfo {
  ...
  void setOverviewSjukskrivningslangdPreviousResult(
      SimpleKonResponse overviewSjukskrivningslangdPreviousResult) {
  ...
  void setOverviewSjukskrivningslangdCurrentResult(
      SimpleKonResponse overviewSjukskrivningslangdCurrentResult) {
  ...
  void setOverviewLangaSjukfallDiffPreviousResult(
      SimpleKonResponse overviewLangaSjukfallDiffResult) {
  ...
  void setOverviewLangaSjukfallDiffCurrentResult(
      SimpleKonResponse overviewLangaSjukfallDiffResult) {
