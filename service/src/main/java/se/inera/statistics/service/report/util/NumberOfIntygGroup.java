...
public enum NumberOfIntygGroup {
  ...
  GROUP11_MORE_THAN_10_INTYG(
      "Över 10 intyg", 11, Integer.MAX_VALUE - 1, ReportColor.ST_COLOR_11.getColor());
  ...
  public static Map<String, String> getColors() {
    return Arrays.stream(values())
        .collect(Collectors.toMap(NumberOfIntygGroup::getGroupName, NumberOfIntygGroup::getColor));
  }
}
