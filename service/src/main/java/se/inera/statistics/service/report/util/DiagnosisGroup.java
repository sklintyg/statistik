...
public enum DiagnosisGroup {
  A00_B99(
      ...
      "A00-E90, G00-L99, N00-N99 Somatiska sjukdomar",
      "A00-B99",
      "C00-D48",
      "D50-D89",
      "E00-E90",
  ...
  P00_P96(
      ReportColor.ST_COLOR_05.getColor(),
      "P00-P96, Q00-Q99, S00-Y98 Övrigt",
      "P00-P96",
      "Q00-Q99",
      "S00-T98",
      "U00-U99",
  ...
  Z00_Z99(
      ReportColor.ST_COLOR_07.getColor(),
  ...
  public static Map<String, String> getColors() {
    return Arrays.stream(values())
        .collect(Collectors.toMap(DiagnosisGroup::getName, DiagnosisGroup::getColor));
  }
}
