...
@NamedQueries({
  ...
  @NamedQuery(
      name = "Enhet.getByVardenhetid",
      query = "SELECT e FROM Enhet e WHERE e.vardenhetId = :veid"),
  @NamedQuery(
      name = "Enhet.getByEnhetids",
      query = "SELECT e FROM Enhet e WHERE e.enhetId IN :enhetids"),
  @NamedQuery(
      name = "Enhet.getByEnhetid",
      query = "SELECT e FROM Enhet e WHERE e.enhetId = :enhetid")
})
