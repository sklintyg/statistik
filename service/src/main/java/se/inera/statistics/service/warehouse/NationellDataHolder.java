...
class NationellDataHolder {
  ...
  ArrayList<SimpleKonDataRow> getOverviewAntalIntygResult() {
    final ArrayList<SimpleKonDataRow> overviewAntalIntygResult = new ArrayList<>();
    if (overviewForandringCurrentResult != null) {
      overviewAntalIntygResult.add(overviewForandringCurrentResult);
    }
  ...
  public void setOverviewForandringPreviousResult(
      SimpleKonDataRow overviewForandringPreviousResult) {
  ...
  void setOverviewPreviousAldersgrupperResult(
      SimpleKonResponse overviewPreviousAldersgrupperResult) {
  ...
  void setOverviewSjukskrivningsgradPreviousResult(
      KonDataResponse overviewSjukskrivningsgradResult) {
  ...
  void setOverviewSjukskrivningsgradCurrentResult(
      KonDataResponse overviewSjukskrivningsgradResult) {
  ...
  void setOverviewSjukfallslangdPreviousResult(
      SimpleKonResponse overviewSjukfallslangdPreviousResult) {
  ...
  void setOverviewSjukfallslangdCurrentResult(
      SimpleKonResponse overviewSjukfallslangdCurrentResult) {
  ...
  void setOverviewLangaSjukfallDiffPreviousResult(
      SimpleKonResponse overviewLangaSjukfallDiffPreviousResult) {
  ...
  public void setOverviewLangaSjukfallDiffCurrentResult(
      SimpleKonResponse overviewLangaSjukfallDiffCurrentResult) {
  ...
  public DiagnosgruppResponse getOverviewDiagnosgrupperResultNullSafe() {
    if (overviewDiagnosgrupperCurrentResult == null
        || overviewDiagnosgrupperPreviousResult == null) {
      return new DiagnosgruppResponse(
          AvailableFilters.getForNationell(), Collections.emptyList(), Collections.emptyList());
    }
    ...
    final List<Icd> icdTyps =
        currentIcdTyps.size() < previousIcdTyps.size() ? previousIcdTyps : currentIcdTyps;
    return new DiagnosgruppResponse(
        AvailableFilters.getForNationell(),
        icdTyps,
        Arrays.asList(
            overviewDiagnosgrupperPreviousResult.getRows().get(0),
            overviewDiagnosgrupperCurrentResult.getRows().get(0)));
  }

  SimpleKonResponse getOverviewForandringResult() {
    final SimpleKonDataRow prev =
        overviewForandringPreviousResult != null
            ? overviewForandringPreviousResult
            : new SimpleKonDataRow("", -1, -1);
    final SimpleKonDataRow curr =
        overviewForandringCurrentResult != null
