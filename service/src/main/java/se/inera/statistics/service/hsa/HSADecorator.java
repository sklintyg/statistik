...
public class HSADecorator {
  ...
  @Autowired private HSAService service;
  ...
  private static ObjectMapper getHsaInfoMapper() {
    ...
    mapper.registerModule(
        new JavaTimeModule()
            .addSerializer(LocalDateTime.class, new OurLocalDateTimeSerializer())
  ...
  /**
   * This dateformat is not recommended (ISO-8601 is default and recommended), but is used for
   * backward compatibility.
   */
  private static class OurLocalDateTimeSerializer
  ...
  private static class OurLocalDateTimeDeserializer
    ...
    public LocalDateTime deserialize(JsonParser p, DeserializationContext ctxt)
      ...
      try {
        return emptyField
            ? null
            : LocalDate.from(DateTimeFormatter.ofPattern("yyyy-MM-dd").parse(p.getText()))
                .atStartOfDay();
