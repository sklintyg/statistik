...
public class VerksamhetsTyp implements Iterable<String> {
    ...
    public VerksamhetsTyp() {
        ...
        longKodToName.put("1039", "Kokleaverksamhet, barn och ungdom, NHV");
        longKodToName.put("1040", "Hjärtkirurgi, barn och ungdom, NHV");
        longKodToName.put("1042", "Ätstörningsvård, barn och ungdom, NHV");
        longKodToName.put("1100", "Akutverksamhet vid sjukhus, allmän");
        ...
        longKodToName.put("1306", "Brännskadevård, NHV");
        ...
        longKodToName.put("1350", "Akutverksamhet vid sjukhus, sexuellt våldsutsatta");
        ...
        longKodToName.put("1517", "Skolhälsovård Elevhälsans medicinska insats (EMI)");
        ...
        longKodToName.put("1620", "Akutverksamhet, psykiatrisk jourteam");
        ...
        longKodToName.put("1629", "Könsdysforiverksamhet, NHV");
        longKodToName.put("1630", "Verksamhet för unga vuxna med psykisk ohälsa");
        longKodToName.put("1631", "Rehabilitering för sexuellt våldsutsatta");
        longKodToName.put("1632", "Ätstörningsvård, vuxna, NHV");
        longKodToName.put("1702", "Datortomografiverksamhet");
        longKodToName.put("1706", "MR-verksamhet");
        longKodToName.put("1707", "Mammografi");
        longKodToName.put("1708", "Radiologi");
