...
public class UpdateEnhetNamnFromHsaFileServiceTest {
    ...
    /**
     * This test will do an end to end test of the fileservice. A webserver will be started locally which makes it possible
     * to download a local fileservice zip file. That file will be downloaded and used to update the database.
     */
    @Test
    public void e2etest() throws Exception {
        ...
        ReflectionTestUtils.setField(updateEnhetNamnFromHsaFileService, "hsaunitsUrl", "http://localhost:" + port + "/hsazip-fileservice-intyg-p.zip");
        ...
        ReflectionTestUtils.setField(updateEnhetNamnFromHsaFileService, "hsaTruststoreFile", cl.getResource("test.statistik.jks").getFile());
