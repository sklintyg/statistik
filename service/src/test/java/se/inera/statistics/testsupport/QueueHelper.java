...
public class QueueHelper {
  ...
  @Autowired private DiagnosgruppQuery diagnosgruppQuery;

  @Autowired private NationellOverviewData nationellOverview;

  @Autowired private SjukfallUtil sjukfallUtil;

  @Autowired private SjukfallQuery sjukfallQuery;

  @Autowired private NationellDataInvoker nationellDataInvoker;

  // CHECKSTYLE:OFF ParameterNumberCheck
  @java.lang.SuppressWarnings("squid:S00107") // Suppress parameter number warning in Sonar
  public void enqueue(
      UtlatandeBuilder builder,
      String typString,
      String person,
      String diagnos,
      List<LocalDate> start,
      List<LocalDate> stop,
      List<String> grad,
      HsaIdEnhet enhet,
    ...
    sender.simpleSend(
        builder.build(person, start, stop, enhet, vardgivare, diagnos, grad).toString(),
        transId,
        typ,
  ...
  public Map<String, TestData> printAndGetPersistedData(
      HsaIdEnhet vardenhet1, HsaIdEnhet vardenhet2, Range range) {
    ...
    final MessagesFilter messagesFilter =
        new MessagesFilter(
            ...
            null,
            null,
            Collections.singleton(vardenhet1),
            Collections.emptySet(),
            Collections.emptySet(),
            Collections.emptySet());
    VerksamhetOverviewResponse verksamhetOverview1 =
        overviewQuery.getOverview(
            warehouse.get(vg),
            sjukfallUtil.createEnhetFilter(vardenhet1),
            range,
            ReportUtil.getPreviousOverviewPeriod(range),
            messagesFilter);
    LOG.info("VO data: " + verksamhetOverview1);
    final MessagesFilter messagesFilter2 =
        new MessagesFilter(
            vg,
            null,
            null,
            Collections.singleton(vardenhet2),
            Collections.emptySet(),
            Collections.emptySet(),
            Collections.emptySet());
    VerksamhetOverviewResponse verksamhetOverview2 =
        overviewQuery.getOverview(
            warehouse.get(vg),
            sjukfallUtil.createEnhetFilter(vardenhet2),
            range,
            ReportUtil.getPreviousOverviewPeriod(range),
            messagesFilter2);
  ...
  private void printAndGetCasesPerCountyNationell(
      Range range, Map<String, TestData> result, NationellDataInfo nationellDataInfo) {
    ...
    result.put(
        "casesPerCountyNationell",
        new TestData(casesPerCountyNationell, casesPerCountyNationellNode));
  }

  private void printAndGetSjukfallslangdGrupp(
      HsaIdEnhet vardenhet1,
      HsaIdEnhet vardenhet2,
      Range range,
      Map<String, TestData> result,
      NationellDataInfo nationellDataInfo) {
    SimpleKonResponse sjukfallslangdGrupp1 =
        SjukskrivningslangdQuery.getSjuksrivningslangd(
            warehouse.get(new HsaIdVardgivare("vg")),
            sjukfallUtil.createEnhetFilter(vardenhet1),
            range.getFrom(),
            YEAR,
            1,
    ...
    result.put(
        "sjukfallslangdGrupp1", new TestData(sjukfallslangdGrupp1, sjukfallslangdGrupp1Node));
    SimpleKonResponse sjukfallslangdGrupp2 =
        SjukskrivningslangdQuery.getSjuksrivningslangd(
            warehouse.get(new HsaIdVardgivare("vg")),
            sjukfallUtil.createEnhetFilter(vardenhet2),
            range.getFrom(),
    ...
    result.put(
        "sjukfallslangdGrupp2", new TestData(sjukfallslangdGrupp2, sjukfallslangdGrupp2Node));
    ...
    JsonNode sjukfallslangdGruppNationellNode =
        JSONParser.parse(sjukfallslangdGruppNationell.toString());
    result.put(
        "sjukfallslangdGruppNationell",
        new TestData(sjukfallslangdGruppNationell, sjukfallslangdGruppNationellNode));
    SimpleKonResponse sjukfallslangdGruppLong1 =
        SjukskrivningslangdQuery.getLangaSjukfall(
            warehouse.get(new HsaIdVardgivare("vg")),
            sjukfallUtil.createEnhetFilter(vardenhet1),
            range.getFrom(),
            QUARTER,
    ...
    result.put(
        "sjukfallslangdGruppLong1",
        new TestData(sjukfallslangdGruppLong1, sjukfallslangdGruppLong1Node));
    SimpleKonResponse sjukfallslangdGruppLong2 =
        SjukskrivningslangdQuery.getLangaSjukfall(
            warehouse.get(new HsaIdVardgivare("vg")),
            sjukfallUtil.createEnhetFilter(vardenhet2),
            range.getFrom(),
    ...
    result.put(
        "sjukfallslangdGruppLong2",
        new TestData(sjukfallslangdGruppLong2, sjukfallslangdGruppLong2Node));
  }

  private void printAndGetDegreeOfSickLeave(
      HsaIdEnhet vardenhet1, HsaIdEnhet vardenhet2, Range range, Map<String, TestData> result) {
    KonDataResponse degreeOfSickLeave1 =
    ...
    KonDataResponse degreeOfSickLeave2 =
        SjukskrivningsgradQuery.getSjukskrivningsgrad(
            warehouse.get(new HsaIdVardgivare("vg")),
            sjukfallUtil.createEnhetFilter(vardenhet2),
            range.getFrom(),
  ...
  private void printAndGetAgeGroups(
      HsaIdEnhet vardenhet1, HsaIdEnhet vardenhet2, Range range, Map<String, TestData> result) {
    SimpleKonResponse ageGroups1 =
        AldersgruppQuery.getAldersgrupper(
            warehouse.get(new HsaIdVardgivare("EnVG")),
            sjukfallUtil.createEnhetFilter(vardenhet1),
            range.getFrom(),
            1,
            YEAR,
    ...
    SimpleKonResponse ageGroups2 =
        AldersgruppQuery.getAldersgrupper(
            warehouse.get(new HsaIdVardgivare("VG2")),
            sjukfallUtil.createEnhetFilter(vardenhet2),
            range.getFrom(),
            1,
            YEAR,
  ...
  private void printAndGetDiagnosisSubGroups(
      HsaIdEnhet vardenhet1,
      HsaIdEnhet vardenhet2,
      Range range,
      Map<String, TestData> result,
      NationellDataInfo nationellDataInfo) {
    DiagnosgruppResponse diagnosisSubGroups1 =
        diagnosgruppQuery.getDiagnosavsnitts(
            warehouse.get(new HsaIdVardgivare("EnVG")),
            sjukfallUtil.createEnhetFilter(vardenhet1),
            range.getFrom(),
            1,
    ...
    DiagnosgruppResponse diagnosisSubGroups2 =
        diagnosgruppQuery.getDiagnosavsnitts(
            warehouse.get(new HsaIdVardgivare("VG2")),
            sjukfallUtil.createEnhetFilter(vardenhet2),
            range.getFrom(),
    ...
    result.put(
        "diagnosisSubGroupsNationell",
        new TestData(nationellDiagnosgrupper, diagnosisSubGroupsNationellNode));
  }

  private void printAndGetDiagnosisGroups(
      HsaIdEnhet vardenhet1,
      HsaIdEnhet vardenhet2,
      Range range,
      Map<String, TestData> result,
      NationellDataInfo nationellDataInfo) {
    DiagnosgruppResponse diagnosisGroups1 =
        diagnosgruppQuery.getDiagnosgrupper(
            warehouse.get(new HsaIdVardgivare("EnVG")),
            sjukfallUtil.createEnhetFilter(vardenhet1),
            range.getFrom(),
            1,
    ...
    DiagnosgruppResponse diagnosisGroups2 =
        diagnosgruppQuery.getDiagnosgrupper(
            warehouse.get(new HsaIdVardgivare("VG2")),
            sjukfallUtil.createEnhetFilter(vardenhet2),
            range.getFrom(),
    ...
    result.put(
        "diagnosisGroupsNationell",
        new TestData(nationellDiagnosgrupper, diagnosisGroupsNationellNode));
  }

  private void printAndGetCasesPerMonth(
      HsaIdEnhet vardenhet1,
      HsaIdEnhet vardenhet2,
      Range range,
      Map<String, TestData> result,
      NationellDataInfo nationellDataInfo) {
    SimpleKonResponse casesPerMonth1 =
    ...
    SimpleKonResponse casesPerMonth2 =
        sjukfallQuery.getSjukfall(
            warehouse.get(new HsaIdVardgivare("EnVG")),
            sjukfallUtil.createEnhetFilter(vardenhet2),
            range.getFrom(),
    ...
    result.put(
        "casesPerMonthNationell", new TestData(casesPerMonthNationell, casesPerMonthNationellNode));
  }
}
