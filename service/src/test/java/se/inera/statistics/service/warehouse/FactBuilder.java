...
public class FactBuilder {
  ...
  public Fact build() {
    if (id == -1
        ...
        || diagnoskategori == -1
        || diagnoskod == -1
        || sjukskrivningsgrad == -1
        || lakarkon == -1
        || lakaralder == -1
        || lakarbefattnings == null
        || lakarid == null
        || enkelt == null) {
  ...
  public FactBuilder withLakarkon(Kon lakarkon) {
    this.lakarkon =
        lakarkon == null
            ? Kon.UNKNOWN.getNumberRepresentation()
            : lakarkon.getNumberRepresentation();
    return this;
  }
  ...
  public static Fact newFact(
    ...
    return new Fact(
        ...
        kommun,
        forsamling,
        new HsaIdEnhet(String.valueOf(enhet)),
        new HsaIdEnhet(String.valueOf(underenhet)),
        lakarintyg,
        patient,
        startdatum,
        slutdatum,
