...
public class CaseInsensiviteStringTest {
  ...
  public void testContainsWorksAsExpected() throws Exception {
    final List<CaseInsensiviteString> caseInsensiviteStrings =
        Arrays.asList(
            new CaseInsensiviteString("Abc1"),
            new CaseInsensiviteString("aBc2"),
            new CaseInsensiviteString("abC3"));
    assertTrue(caseInsensiviteStrings.contains(new CaseInsensiviteString("abc1")));
    assertEquals(
        "aBc2",
        caseInsensiviteStrings
            .get(caseInsensiviteStrings.indexOf(new CaseInsensiviteString("ABC2")))
            .getString());
  }
}
