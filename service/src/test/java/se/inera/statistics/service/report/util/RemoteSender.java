...
public class RemoteSender {
  ...
  @Autowired private Queue destination;
  ...
  public void send() {
    ...
    simpleSend(
        builder
            .build(
                "20121212-2212",
                LocalDate.parse("2013-10-20"),
                LocalDate.parse("2013-11-11"),
                new HsaIdLakare("TST5565595230-106J"),
                new HsaIdEnhet("IFV1239877878-103H"),
    ...
    simpleSend(
        builder
            .build(
                ...
                LocalDate.parse("2013-11-11"),
                new HsaIdLakare("TST5565595230-106J"),
                new HsaIdEnhet(longify("IFV1239877878-103H", 100)),
                new HsaIdVardgivare(longify("IFV1239877878-0001", 100)),
                "D01",
                0)
            .toString(),
        UUID.randomUUID().toString());
      ...
      simpleSend(
          builder
              .build(
                  ...
                  LocalDate.parse("2013-10-20"),
                  LocalDate.parse("2013-11-11"),
                  new HsaIdLakare(lakarid),
                  new HsaIdEnhet(enhetid),
                  new HsaIdVardgivare(vargivarid),
                  "D01",
                  0)
              .toString(),
          uuid);
  ...
  public static void main(String[] args) throws InterruptedException {
    try (ClassPathXmlApplicationContext context =
        new ClassPathXmlApplicationContext("classpath:send-to-mq-context.xml")) {
