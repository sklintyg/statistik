...
public class HSAServiceImplTest {
  ...
  public static final GetStatisticsHsaUnitResponseDto WS_ENHET =
      createGetStatisticsHsaUnitResponseDto();
  ...
  private static GetStatisticsHsaUnitResponseDto
      createGetStatisticsHsaUnitResponseTypeWhereHuvudenhetHasVg() {
    GetStatisticsHsaUnitResponseDto responseType = new GetStatisticsHsaUnitResponseDto();
    StatisticsHsaUnitDto unit = new StatisticsHsaUnitDto();
    unit.setHsaIdentity("UnitId");
    responseType.setStatisticsUnit(unit);
  ...
  public static final GetStatisticsCareGiverResponseDto WS_VG =
      createGetStatisticsCareGiverResponseDto();
  ...
  public static final GetStatisticsPersonResponseDto WS_PERSON =
      createGetStatisticsPersonResponseDto();
  ...
  @Mock private HsaStatisticsService wsCalls;

  @InjectMocks private HSAServiceImpl serviceImpl = new HSAServiceImpl();

  @Test
  public void serviceReturnsNullOnException() throws Exception {
    HSAKey key = new HSAKey("vardgivareId", "enhetId", "lakareId");
    when(wsCalls.getStatisticsHsaUnit("ENHETID"))
        .thenThrow(new IllegalStateException("This WS generated and exception"));
  ...
  private HsaInfoEnhet getHsaInfoEnhet(String vgid) {
    return new HsaInfoEnhet(
        ...
        Arrays.asList(""),
        Arrays.asList(""),
        new HsaInfoEnhetGeo(new HsaInfoCoordinate("", "", ""), "", "", "", "", ""),
        vgid);
  }
  ...
  @Test
  public void testGetHsaInfoCorrectResultAndDoesOnlyCallCorrectWsWhenBaseInfoIsMissingEnhet()
      throws Exception {
    // Given
    setupHsaWsCalls();
    final HsaInfo baseHsaInfo =
        new HsaInfo(null, getHsaInfoEnhet("cachedvgid"), getHsaInfoVg(), getHsaInfoPersonal());
  ...
  @Test
  public void testGetHsaInfoDoesCallWsWhenBaseInfoIsMissingEnhetAndHuvudenhetIsMissingVg()
      throws Exception {
    // Given
    String enhetId = "b";
    setupHsaWsCalls();
    Mockito.doReturn(createGetStatisticsHsaUnitResponseTypeWhereHuvudenhetHasVg())
        .when(wsCalls)
        .getStatisticsHsaUnit(anyString());
    final HsaInfo baseHsaInfo =
        new HsaInfo(null, getHsaInfoEnhet("cachedvgid"), null, getHsaInfoPersonal());
  ...
  @Test
  public void testGetHsaInfoCorrectResultAndDoesOnlyCallCorrectWsWhenBaseInfoIsMissingHuvudenhet()
      throws Exception {
    // Given
    setupHsaWsCalls();
    final HsaInfo baseHsaInfo =
        new HsaInfo(getHsaInfoEnhet(null), null, getHsaInfoVg(), getHsaInfoPersonal());
  ...
  @Test
  public void testGetHsaInfoCorrectResultAndDoesOnlyCallCorrectWsWhenBaseInfoIsMissingPersonal()
      throws Exception {
    // Given
    setupHsaWsCalls();
    final HsaInfo baseHsaInfo =
        new HsaInfo(
            getHsaInfoEnhet("cachedvgid"), getHsaInfoEnhet("cachedvgid"), getHsaInfoVg(), null);
  ...
  @Test
  public void testGetHsaInfoCorrectResultAndDoesOnlyCallCorrectWsWhenBaseInfoIsMissingVg()
      throws Exception {
    // Given
    setupHsaWsCalls();
    final HsaInfo baseHsaInfo =
  ...
  public void testGetHsaInfoForHuvudenhetIsNotCalledWhenEnhetHasVgid() throws Exception {
    ...
    setupHsaWsCalls();
    final HsaInfo baseHsaInfo =
        new HsaInfo(getHsaInfoEnhet("cachedvgid"), null, getHsaInfoVg(), getHsaInfoPersonal());
  ...
  @Test
  public void
      testGetHsaInfoForHuvudenhetIsOnlyCalledForHuvudenhetWhenEnhetHasNoVgidAndHuvudenhetIsMissing()
          throws Exception {
    // Given
    setupHsaWsCalls();
    final HsaInfo baseHsaInfo =
