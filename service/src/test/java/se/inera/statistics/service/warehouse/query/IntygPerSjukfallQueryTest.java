...
public class IntygPerSjukfallQueryTest {
  ...
  private void verifyTidsserieWithOneCaseForFemaleWithTwoIntygAndOneCaseForMaleWithOneIntyg(
      KonDataResponse result, String name, int index) {
    assertEquals(name, result.getRows().get(index).getName());
  ...
  public void testTidsserieWithOneCaseForFemaleWithTwoIntygAndOneCaseForMaleWithOneIntyg() {
    ...
    KonDataResponse result =
        IntygPerSjukfallQuery.getIntygPerSjukfallTidsserie(
            aisle.createAisle(),
            SjukfallUtil.ALL_ENHETER,
            range.getFrom(),
            PERIOD_LENGTH_12,
    ...
    verifyTidsserieWithOneCaseForFemaleWithTwoIntygAndOneCaseForMaleWithOneIntyg(
        result, "maj 2014", index++);
    verifyTidsserieWithOneCaseForFemaleWithTwoIntygAndOneCaseForMaleWithOneIntyg(
        result, "jun 2014", index++);
  ...
  public void testRegionWithOneCaseForFemaleWithTwoIntygAndOneCaseForMaleWithOneIntyg() {
    ...
    SimpleKonResponse result =
        intygPerSjukfallQuery.getIntygPerSjukfallTvarsnittRegion(
            aisle.createAisle(),
            SjukfallUtil.ALL_ENHETER,
            range.getFrom(),
            PERIOD_1,
  ...
  @Test
  public void
      testRegionWithOneCaseForFemaleWithTwoIntygAndOneCaseForMaleWithOneIntygNoResultsBecauseOfCutoff() {
    aisle.addLine(fact(PATIENT1_ID, Kon.FEMALE, LAKARE1_ID));
    aisle.addLine(fact(PATIENT1_ID, Kon.FEMALE, LAKARE1_ID));
    aisle.addLine(fact(PATIENT2_ID, Kon.MALE, LAKARE2_ID));
