...
public class DeleteCustomerDataDBImplTest {
  ...
  @InjectMocks private DeleteCustomerDataDBImpl deleteCustomerDataDB;
  ...
  public void testDeleteFromIntyghandelse() throws SQLException {
    ...
    verify(connection, times(1))
        .prepareStatement("DELETE FROM intyghandelse WHERE correlationId = ?");
    verify(preparedStatement, times(1)).setString(1, INTYGSID);
    verify(preparedStatement, times(1)).executeUpdate();
    verify(preparedStatement, times(1)).close();
  }
  ...
  public void testDeleteFromMeddelandehandelseAndMessagewideline() throws SQLException {
    ...
    when(preparedStatement.executeUpdate())
        .thenReturn(deleteFromMeddelandehandelseResult, deleteFromMessagewidelineResult);

    MeddelandehandelseMessagewidelineResult result =
  ...
  @Test
  public void testDeleteFromMeddelandehandelseAndMessagewidelineMeddelandehandelseException()
      throws SQLException {
    when(preparedStatement.executeUpdate()).thenThrow(new SQLException());
  ...
  @Test
  public void testDeleteFromMeddelandehandelseAndMessagewidelineMessagewidelineException()
      throws SQLException {
    Integer deleteFromMeddelandehandelseResult = 1;
    when(preparedStatement.executeUpdate())
        .thenReturn(deleteFromMeddelandehandelseResult)
  ...
  public void testDeleteFromIntygsenthandelse() throws SQLException {
    ...
    verify(connection, times(1)).setAutoCommit(true);
    verify(connection, times(1))
        .prepareStatement("DELETE FROM intygsenthandelse WHERE correlationId = ?");
    verify(preparedStatement, times(1)).setString(1, INTYGSID);
    verify(preparedStatement, times(1)).executeUpdate();
    verify(preparedStatement, times(1)).close();
  }
