...
class RegisterCertificateResolverTest {
  ...
  @InjectMocks RegisterCertificateResolver registerCertificateResolver;

  @Mock RegisterCertificateHelper registerCertificateHelper;

  @Mock FkRegisterCertificateHelper fkRegisterCertificateHelper;

  @Mock Ag7804RegisterCertificateHelper ag7804RegisterCertificateHelper;

  @Mock Ag114RegisterCertificateHelper ag114RegisterCertificateHelper;
