  ...
  <div class="header clearfix hidden-print">
    <div class="headerbox">
      ...
      <span class="headerbox-date pull-left">
        ...
        <div class="headerbox-info-text"  data-ng-class="{'headerbox-info-text-padding': !(isLoggedIn && verksamhetName)}" message key="statistics.header.extra-text"></div>
      </span>
    </div>
...
<script type="text/javascript" src="<c:url value='/webjars/angularjs/1.2.29/angular-cookies.min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/webjars/angularjs/1.2.29/angular-route.min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/webjars/angularjs/1.2.29/angular-sanitize.min.js'/>"></script>
...
<script type="text/javascript" src="<c:url value='/js/lib/highcharts/4.2.3/highcharts.js'/>"></script>
<script type="text/javascript" src="<c:url value='/js/lib/highcharts/4.2.3/modules/highcharts-more.js'/>"></script>
<script type="text/javascript" src="<c:url value='/js/lib/highcharts/4.2.3/modules/exporting.js'/>"></script>
