    ...
    function ($scope) {
        ...
        faq.push({
            ...
            body: '<p>Det landstingsägda bolaget Inera AB har tagit fram tjänsten och ' +
                        'förvaltar den på uppdrag av Sveriges kommuner och landsting.</p>'
        });

        faq.push({
            title: '3. Vad innehåller Statistiktjänsten?',
            body: '<p>Statistiktjänsten innehåller endast intygsinformation från hälso- och sjukvården. ' +
                        'Innehållet baseras på det elektroniska läkarintyg som utfärdas när en läkare bedömer att en individ behöver sjukskrivas. ' +
            'Tjänsten innehåller information från samtliga elektroniska läkarintyg som utfärdats inom hälso- och sjukvården.</p>'+
                    '<p>Statistiktjänsten registrerar inte om intyget används för ansökan om sjukpenning hos Försäkringskassan, ' +
                        'eller vilken bedömning Försäkringskassan gör. ' +
                        'Statistiken baseras bara på hälso- och sjukvårdens ordinerade sjukskrivning.</p>'+
        ...
        faq.push({
            ...
            body: '<p>Nationell statistik är statistik för alla elektroniska läkarintyg som utfärdats av landets olika vårdgivare. ' +
                        'Statistiken avidentifieras och slås ihop innan den sammanställs på nationell nivå.</p>' +
                    '<p>För att statistiken inte ska kunna kopplas till enskilda personer filtreras den från uppgifter ' +
                        'som skulle kunna röja en persons identitet. ' +
                        'Det kan leda till en liten felmarginal i statistiken då det presenterade antalet sjukfall ' +
                        'kan skilja sig något från det faktiska antalet, på grund av filtreringen.</p>'
        });

        faq.push({
            title: '5. Hur ofta uppdateras Statistiktjänsten?',
            body: '<p>Statistiktjänsten uppdateras löpande med nya läkarintyg. Den övervägande delen av statistiken som presenteras ' +
                        'innehåller data fram till och med den senast avslutade kalendermånaden.</p>' +
                    '<p>Undantaget är rapporter för verksamhetsstatistik om pågående sjukskrivning, som endast visar pågående månads läkarintyg. ' +
                        'Dessa rapporter kan bara ses i inloggat läge av användare inom hälso- och sjukvården.</p>'
        });
        faq.push({
        ...
        faq.push({
            ...
            body: '<p>Ett sjukfall omfattar alla de elektroniska läkarintyg som utfärdats för en viss patient vid en sjukskrivning ' +
                        'och som följer på varandra med max fem dagars uppehåll.</p>' +
                    '<p>Exempel: Om intyg 1 gäller till den 14 augusti och intyg 2 gäller från den 17 augusti ' +
                        'ses de båda intygen som samma sjukfall. ' +
                        'Men om intyg 2 istället varit giltigt från den 21 augusti skulle intygen ha räknats som två skilda sjukfall.</p>'
        });
        faq.push({
            title: '8. Vad innebär pågående sjukfall?',
            body: '<p>Rapporten ”pågående sjukfall” visar så aktuell information om sjukfallen som möjligt. ' +
                        'Alla sjukfall som varar någon gång under pågående månad ingår i rapporten. ' +
                        'I slutet av månaden kommer därför även sjukfall som avslutats under månaden att visas som pågående sjukfall.</p>'
        });
        faq.push({
        ...
        faq.push({
            ...
            body: '<p>På varje rapportsida finns en knapp med texten ”Spara/Skriv ut” ovanför diagrammet. ' +
                    'När du väljer ”Spara tabell till Excel” laddas tabellen automatiskt ner på din dator och går att öppna i Excel.</p>'
        });
        faq.push({
