...
public class QueueHelper {
    ...
    public void enqueue(UtlatandeBuilder builder, String typString, String person, String diagnos, List<LocalDate> start, List<LocalDate> stop, List<String> grad, HsaId enhet, HsaId vardgivare, String transId) {
    ...
    public Map<String, TestData> printAndGetPersistedData(HsaId vardenhet1, HsaId vardenhet2, Range range) {
    ...
    private void printAndGetSjukfallslangdGrupp(HsaId vardenhet1, HsaId vardenhet2, Range range, Map<String, TestData> result) {
        SimpleKonResponse<SimpleKonDataRow> sjukfallslangdGrupp1 = SjukskrivningslangdQuery.getSjuksrivningslangd(warehouse.get(new HsaId("vg")), sjukfallUtil.createEnhetFilter(vardenhet1), range.getFrom(), YEAR, 1, sjukfallUtil);
        ...
        SimpleKonResponse<SimpleKonDataRow> sjukfallslangdGrupp2 = SjukskrivningslangdQuery.getSjuksrivningslangd(warehouse.get(new HsaId("vg")), sjukfallUtil.createEnhetFilter(vardenhet2), range.getFrom(), YEAR, 1, sjukfallUtil);
        ...
        SimpleKonResponse<SimpleKonDataRow> sjukfallslangdGruppLong1 = SjukskrivningslangdQuery.getLangaSjukfall(warehouse.get(new HsaId("vg")), sjukfallUtil.createEnhetFilter(vardenhet1), range.getFrom(), QUARTER, 1, sjukfallUtil);
        ...
        SimpleKonResponse<SimpleKonDataRow> sjukfallslangdGruppLong2 = SjukskrivningslangdQuery.getLangaSjukfall(warehouse.get(new HsaId("vg")), sjukfallUtil.createEnhetFilter(vardenhet2), range.getFrom(), QUARTER, 1, sjukfallUtil);
    ...
    private void printAndGetDegreeOfSickLeave(HsaId vardenhet1, HsaId vardenhet2, Range range, Map<String, TestData> result) {
        KonDataResponse degreeOfSickLeave1 = SjukskrivningsgradQuery.getSjukskrivningsgrad(warehouse.get(new HsaId("vg")), sjukfallUtil.createEnhetFilter(vardenhet1), range.getFrom(), 1, YEAR, sjukfallUtil);
        ...
        KonDataResponse degreeOfSickLeave2 = SjukskrivningsgradQuery.getSjukskrivningsgrad(warehouse.get(new HsaId("vg")), sjukfallUtil.createEnhetFilter(vardenhet2), range.getFrom(), 1, YEAR, sjukfallUtil);
    ...
    private void printAndGetAgeGroups(HsaId vardenhet1, HsaId vardenhet2, Range range, Map<String, TestData> result) {
        SimpleKonResponse<SimpleKonDataRow> ageGroups1 = AldersgruppQuery.getAldersgrupper(warehouse.get(new HsaId("EnVG")), sjukfallUtil.createEnhetFilter(vardenhet1), range.getFrom(), 1, YEAR, sjukfallUtil);
        ...
        SimpleKonResponse<SimpleKonDataRow> ageGroups2 = AldersgruppQuery.getAldersgrupper(warehouse.get(new HsaId("VG2")), sjukfallUtil.createEnhetFilter(vardenhet2), range.getFrom(), 1, YEAR, sjukfallUtil);
    ...
    private void printAndGetDiagnosisSubGroups(HsaId vardenhet1, HsaId vardenhet2, Range range, Map<String, TestData> result) {
        DiagnosgruppResponse diagnosisSubGroups1 = diagnosgruppQuery.getDiagnosavsnitts(warehouse.get(new HsaId("EnVG")), sjukfallUtil.createEnhetFilter(vardenhet1), range.getFrom(), 1, YEAR, "A00-B99");
        ...
        DiagnosgruppResponse diagnosisSubGroups2 = diagnosgruppQuery.getDiagnosavsnitts(warehouse.get(new HsaId("VG2")), sjukfallUtil.createEnhetFilter(vardenhet2), range.getFrom(), 1, YEAR, "A00-B99");
    ...
    private void printAndGetDiagnosisGroups(HsaId vardenhet1, HsaId vardenhet2, Range range, Map<String, TestData> result) {
        DiagnosgruppResponse diagnosisGroups1 = diagnosgruppQuery.getDiagnosgrupper(warehouse.get(new HsaId("EnVG")), sjukfallUtil.createEnhetFilter(vardenhet1), range.getFrom(), 1, YEAR);
        ...
        DiagnosgruppResponse diagnosisGroups2 = diagnosgruppQuery.getDiagnosgrupper(warehouse.get(new HsaId("VG2")), sjukfallUtil.createEnhetFilter(vardenhet2), range.getFrom(), 1, YEAR);
    ...
    private void printAndGetCasesPerMonth(HsaId vardenhet1, HsaId vardenhet2, Range range, Map<String, TestData> result) {
        SimpleKonResponse<SimpleKonDataRow> casesPerMonth1 = sjukfallQuery.getSjukfall(warehouse.get(new HsaId("EnVG")), sjukfallUtil.createEnhetFilter(vardenhet1), range.getFrom(), range.getMonths(), 1, false);
        ...
        SimpleKonResponse<SimpleKonDataRow> casesPerMonth2 = sjukfallQuery.getSjukfall(warehouse.get(new HsaId("EnVG")), sjukfallUtil.createEnhetFilter(vardenhet2), range.getFrom(), range.getMonths(), 1, false);
